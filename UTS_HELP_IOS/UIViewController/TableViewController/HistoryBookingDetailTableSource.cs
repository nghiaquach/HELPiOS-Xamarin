...
namespace HELPiOS
{
	public class HistoryBookingDetailTableSource : UITableViewSource {

		WorkshopBooking workshopBooking;
		SessionBooking sessionBooking;
		NSString cellIdentifier = new NSString("TableCell");

		public HistoryBookingDetailTableSource (WorkshopBooking workshopBooking, SessionBooking sessionBooking)
		{
